    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<NavItemPrice, ItemPrice>()
              ...
              .ForMember(dest => dest.StartDate, opts => opts.MapFrom(src => src.Starting_Date))
              .ForMember(dest => dest.EndDate, opts => opts.MapFrom(src => src.Ending_Date))
            ...
            CreateMap<NavCustomer, Customer>()
               ...
               .ForMember(dest => dest.CustomerPriceGroup, opts => opts.MapFrom(src => src.Customer_Price_Group))
               .ForMember(dest => dest.Member_Id, opts => opts.NullSubstitute(0));

            CreateMap<Customer, NavCustomer>()
              .ForMember(dest => dest.id, opts => opts.Ignore())
            ...
            .ForMember(dest => dest.Id, opts => opts.Ignore())
             .ForMember(dest => dest.MenuId, opts => opts.MapFrom(src => src.Menu_Code))
