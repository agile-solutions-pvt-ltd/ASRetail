...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public void PostSalesInvoiceCompletedSignalToNav(Config config, Guid invoiceId, string invoiceNumber)
        {
            ...
            else
            {
                ...
                {
                    string errorMessage = "Error Sale Invoice post, InvoiceNo= " + invoiceNumber + " Message= " + response.Content + "  " + DateTime.Now.ToString() + Environment.NewLine;
                    WriteToFile(Path.GetFullPath("logs/"), "NAVSyncLog.log", errorMessage);
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public void PostCreditInvoiceCompletedSignalToNav(Config config, Guid invoiceId, string invoiceNumber)
        {
            ...
            else
            {
                ...
                {
                    string errorMessage = "Error Credit Note post, Credit Note= " + invoiceNumber + " Message= " + response.Content + "  " + DateTime.Now.ToString() + Environment.NewLine;
                    WriteToFile(Path.GetFullPath("logs/"), "NAVSyncLog.log", errorMessage);
