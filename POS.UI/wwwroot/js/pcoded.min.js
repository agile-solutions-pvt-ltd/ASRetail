...
$.fn.pcodedmenu = function(settings) {
    ...
    if ($.cookie("defaultVerticalMenu.desktop") !== undefined) {
        settings.defaultVerticalMenu.desktop = $.cookie("defaultVerticalMenu.desktop");
    }
    var PcodedMenu = {
        PcodedMenuInit: function () {
            ...
            PcodedMenu.HandleSidebarToggle();
        ...
        HandleSidebarToggle: function () {           
            ...
            if (dt === "desktop") {
                $('#' + oid).attr("vertical-nav-type", settings.defaultVerticalMenu.desktop);
                settings.onToggleVerticalMenu.desktop = PcodedMenu.GetToggleVerticalMenu(dt, settings.defaultVerticalMenu.desktop);
            } else if (dt == "tablet") {
                $('#' + oid).attr("vertical-nav-type", settings.defaultVerticalMenu.tablet);
                settings.onToggleVerticalMenu.tablet = PcodedMenu.GetToggleVerticalMenu(dt, settings.defaultVerticalMenu.tablet);
               
            } else if (dt == "phone") {               
                $('#' + oid).attr("vertical-nav-type", settings.defaultVerticalMenu.phone);
                settings.onToggleVerticalMenu.phone = PcodedMenu.GetToggleVerticalMenu(dt, settings.defaultVerticalMenu.phone);
                ...
                $('#mobile-collapse,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a').on("click", function () {
                    ...
                    if (dt == "desktop") {
                        ...
                        if (dn == dm) {
                            ...
                            $.cookie("defaultVerticalMenu.desktop", dmc);
                            $.cookie("onToggleVerticalMenu.desktop", dn);
                        } else if (dn == dmc) {
                            $('#' + oid).attr("vertical-nav-type", dm);
                            $.cookie("defaultVerticalMenu.desktop", dm);
                            $.cookie("onToggleVerticalMenu.desktop", dn);
                        } else {
                            return false;
                        }
        ...
        GetToggleVerticalMenu: function (dt, menu) {           
            if (dt === "desktop") {
                if (menu === "expanded")
                    return "collapsed";
